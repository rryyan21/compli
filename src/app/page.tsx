...
export default function Home() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    return (
    <main className="min-h-screen w-full bg-[var(--background)] flex flex-col items-center justify-start px-4">
      {/* Hero Section */}
      <section className="w-full max-w-4xl mx-auto flex flex-col items-center justify-center text-center pt-32 pb-20">
        ...
        <p className="text-xl md:text-2xl text-[var(--foreground)]/80 mb-10 max-w-2xl mx-auto">
        ...
        <Link href="/search">
          <button className="btn-primary px-10 py-4 text-xl font-bold">
            Get Started
          </button>
        </Link>
      </section>
      ...
      <section className="w-full max-w-5xl mx-auto grid md:grid-cols-3 gap-8 mb-24">
        <div className="card p-8 flex flex-col items-center text-center hover:scale-105 transition-transform">
          <Search size={40} className="text-blue-400 mb-4" />
          <h3 className="text-xl font-semibold mb-2">Company Search</h3>
          <p className="text-[var(--foreground)]/70">Find official websites, summaries, and news for any company in seconds.</p>
        </div>
        <div className="card p-8 flex flex-col items-center text-center hover:scale-105 transition-transform">
          <Sparkles size={40} className="text-purple-400 mb-4" />
          <h3 className="text-xl font-semibold mb-2">Interview Insights</h3>
          <p className="text-[var(--foreground)]/70">Access real interview questions, experiences, and prep plans for top roles.</p>
        </div>
        <div className="card p-8 flex flex-col items-center text-center hover:scale-105 transition-transform">
          <Users size={40} className="text-cyan-400 mb-4" />
          <h3 className="text-xl font-semibold mb-2">Contact Discovery</h3>
          <p className="text-[var(--foreground)]/70">Find LinkedIn profiles of employees by company, role, or university.</p>
        </div>
        <div className="card p-8 flex flex-col items-center text-center hover:scale-105 transition-transform md:col-span-1">
          <BarChart3 size={40} className="text-green-400 mb-4" />
          <h3 className="text-xl font-semibold mb-2">Personal Dashboard</h3>
          <p className="text-[var(--foreground)]/70">Save companies, track your research, and revisit your progress anytime.</p>
        </div>
        <div className="card p-8 flex flex-col items-center text-center hover:scale-105 transition-transform md:col-span-1">
          <ShieldCheck size={40} className="text-yellow-400 mb-4" />
          <h3 className="text-xl font-semibold mb-2">Privacy & Security</h3>
          <p className="text-[var(--foreground)]/70">Your data is protected with industry best practices and never sold.</p>
        </div>
        <div className="card p-8 flex flex-col items-center text-center hover:scale-105 transition-transform md:col-span-1">
          <Rocket size={40} className="text-pink-400 mb-4" />
          <h3 className="text-xl font-semibold mb-2">Fast & Reliable</h3>
          <p className="text-[var(--foreground)]/70">Enjoy instant results and 99.99% uptime, powered by modern cloud tech.</p>
        </div>
      </section>
      ...
      <section className="w-full max-w-xl mx-auto mb-24">
        <div className="card p-8 flex flex-col items-center text-center">
          ...
          <p className="text-[var(--foreground)]/70 mb-6">Let us know what you think or how we can improve Compli.</p>
          {submitted ? (
      ...
      <section className="w-full max-w-2xl mx-auto text-center pb-24">
        ...
        <p className="text-lg text-[var(--foreground)]/70 mb-6">Jump into your next opportunity with confidence. Compli is currently in beta and is free to use!</p>
        <Link href="/search">
